function main_mpdx_fp, shotnum, calib_id, restorecalib=restorecalib, printit=printit, plotit=plotit, shadeit=shadeit
...
shotSQLdata = get_sql_data_rev3(shotstr)	;changed to rev3 by D.Weisberg on 2016/01/12
