...
&=tt'a_{in}\sum_{p=0}^{\infty}(rr'e^{i\delta})^{p}\\
&=a_{in}\frac{tt'}{1-rr'e^{i\delta}}
\end{align*}
...
\end{equation}
with $A=2\pi n d / \lambda$.  With this function the distance between interference peaks drops as we move out in $r$
...
\centering
\includegraphics{Images/OpticalLayout.png}
\end{sidewaysfigure}



%\begin{center}
%\includegraphics[width=\textwidth]{Images/OpticalLayout(fiber).png}
%\end{center}
